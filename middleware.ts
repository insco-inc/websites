...
export const config = {
  // matcher: '/:lng*'
  matcher: [
    "/((?!backend|_next/static|_next/image|images|videos|assets|favicon.ico|logo.png|ads.txt|sitemap.xml|rss.xml|robots.txt|manifest.json|manifest.webmanifest|sw.js).*)",
    { source: "/" },
  ],
};
